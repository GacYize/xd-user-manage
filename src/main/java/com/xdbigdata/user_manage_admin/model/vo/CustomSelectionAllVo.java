...
@Data
public class CustomSelectionAllVo {
    /**
     * 学号
     */
    ...
    public String getGrade() {
        this.grade = OrganizationUtil.getGrade(this.gradeId);
        return grade;
    }
    ...
    public String getGender() {
        this.gender = DictionaryUtil.getName(this.gender_id);
//        this.gender = gender_id != null && gender_id.equals(1L) ? "男" : "女";
        return gender;
    }
    ...
    public String getNation() {
        this.nation = DictionaryUtil.getName(this.nation_id);
        return nation;
    }
    ...
    public String getPoliticsStatus() {
        this.politicsStatus = DictionaryUtil.getName(this.politics_status_id);
    ...
    public String getNativePlace() {
        this.nativePlace = OriginPlaceUtils.getName(this.native_place_code);
        return nativePlace;
    }
    ...
    public String getHealthState() {
        this.healthState = DictionaryUtil.getName(this.health_state_id);
        return healthState;
    }
    ...
    public String getBloodType() {
        this.bloodType = DictionaryUtil.getName(this.blood_type_id);
        return bloodType;
    }
    ...
    public String getReligion() {
        this.religion = DictionaryUtil.getName(this.religion_id);
        return religion;
    }
    ...
    public String getCurrentDomicilePalce() {
        this.currentDomicilePlace = OriginPlaceUtils.getName(this.current_domicile_place_code);
        return currentDomicilePlace;
    }
    ...
    public String getMaritalStatus() {
        this.maritalStatus = DictionaryUtil.getName(this.marital_status_id);
    ...
    public String getFamilyPlace() {
        this.familyPlaceName = OriginPlaceUtils.getName(this.family_place);
        return familyPlaceName;
    }
    ...
    public String getCollegeName() {
        this.collegeName = OrganizationUtil.getName(this.college);
        return collegeName;
    }
    ...
    public String getMajorName() {
        this.majorName = OrganizationUtil.getName(this.major);
        return majorName;
    }
    ...
    public String getClassName() {
        this.classesName = OrganizationUtil.getName(this.classes);
        return classesName;
    }
    ...
    public String getEducationStatus() {
        this.educationStatus = DictionaryUtil.getName(this.education_status_id);
    ...
    public String getEducation() {
        this.education = DictionaryUtil.getName(this.education_id);
        return education;
    }
    ...
    public String getDomicilePlace() {
        this.domicilePlace = OriginPlaceUtils.getName(this.domicile_place_code);
    ...
    public String getSourcePlace() {
        this.sourcePlace = OriginPlaceUtils.getName(this.source_place_code);
        return sourcePlace;
    }
